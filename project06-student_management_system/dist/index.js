...
const enrollStudent = () => {
    ...
    inquirer
        ...
        console.log(`${answers.course.name} enrolled for ${answers.student.name}`);
        mainMenu();
    });
};
const viewBalance = () => {
    ...
    inquirer
        ...
        inquirer
            ...
            try {
                ...
                console.log(`Payment of $${answers.course.tuition} received for ${student.name}'s ${answers.course.course}`);
            }
            catch (error) {
